...
[allTagCounts,perWordTagCounts,transitionCounts,emissionCounts,A,B]=learn_params(tagged_sentences=tagged_sentences)
...
tag1=tag_sentence(tagged_sentences[0],{'baseline': [perWordTagCounts, allTagCounts]})
...
tag2=tag_sentence(tagged_sentences[0],{'hmm': [A,B]})
print("hmm tagging")
...
tag3=tag_sentence(tagged_sentences[0],{'blstm':model})
...
model=initialize_rnn_model(model_param)
train_rnn(model, tagged_sentences)
tag4=tag_sentence(tagged_sentences[0],{'cblstm':model})
